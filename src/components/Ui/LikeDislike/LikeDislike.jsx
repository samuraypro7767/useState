...
export const LikeDislike = () => {
  ...
  const handleLikeChange = () => {
    ...
    setLikeCount(likeChecked ? likeCount - 1 : likeCount + 1);
  };
  ...
  const handleDislikeChange = () => {
    ...
    setDislikeCount(dislikeChecked ? dislikeCount - 1 : dislikeCount + 1);
  };
  ...
  return (
    <>
      <div className="like-dislike-container">
        ...
        <p className="text-content">¿Qué te pareció este sitio?</p>
