        ...
        <div className="icons-box">
            <div className="icons">
                <label className="btn-label" for="like-checkbox">
                    <span className="like-text-content">12</span>
                    <input className="input-box" id="like-checkbox" type="checkbox"></input>
            ...
            <div className="icons">
                <label className="btn-label" for="dislike-checkbox">
                    <input className="input-box" id="dislike-checkbox" type="checkbox"></input>
                    <div className="fireworks">
                    ...
                    <span className="dislike-text-content">2</span>
                </label>
            </div>
        </div>
    </div>
